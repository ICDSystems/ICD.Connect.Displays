...
{
    public class RelayDisplayLiftExternalTelemetryProvider : IRelayDisplayLiftExternalTelemetryProvider
    {
        ...
        private void UpdateValues(RelayDisplayLiftDevice parent)
        {
            UpdateLatchMode();
            UpdateExtendTime();
            UpdateRetractTime();
